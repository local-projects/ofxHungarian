...
meta:
	ADDON_NAME = ofxHungarian
	ADDON_DESCRIPTION = Hungarian Algorithm
	ADDON_AUTHOR = @bensnell
	ADDON_TAGS = "hungarian" "tracking" "linear" "assignment" "algorithm"
	ADDON_URL = http://github.com/local-projects/ofxHungarian
